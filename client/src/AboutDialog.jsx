...
function AboutDialog() {
  ...
  return (
    <dialog 
      id="about-dialog" 
      className="max-w-[612px] w-4/5 md:w-1/2 p-5 relative flex flex-col gap-2 border bg-inherit shadow-[3px_3px_black] dark:shadow-[3px_3px_white] backdrop:bg-black backdrop:opacity-50"
    >
      ...
      <p className="text-center">Web ini dipergunakannya untuk mencari-mencari podcast gjls favoritmu itu pun. Dirimu bisa pencarian dengan puncline, diksi, judul, atau kata yang ada dalam ingatan itu sih.</p>
